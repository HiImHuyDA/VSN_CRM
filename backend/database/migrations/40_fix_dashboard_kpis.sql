...
-- ============================================================
-- 40_fix_dashboard_kpis.sql
-- Cập nhật logic các chỉ số KPI trong usp_GetDashboardV2
-- ============================================================
...
BEGIN
    ...
    -- Thẻ 1: Tổng số đơn có ngày tiếp đón thuộc tháng này (không tính huỷ)
    ...
    -- Đơn tháng trước (MoM) để so sánh (dựa trên ngày tiếp đón)
    ...
    -- Thẻ 2: Đang chờ tiếp đón (Đơn đã được BOD duyệt và có ngày tiếp đón trong tương lai)
    ...
    -- Thẻ 4: Các task gần tới deadline (chỉ đếm đơn đã được BOD duyệt & chưa qua ngày tiếp đón, task chưa hoàn thành)

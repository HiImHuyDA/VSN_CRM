...
-- ============================================================
-- usp_CancelSubmission
-- Hủy đơn bằng cách tạo bản ghi mới (RecordType = 3)
-- ============================================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- 3. Copy dữ liệu cũ thành RecordType = 3, Status = 'Đã huỷ'
        ...
        SELECT 
            ...
            [GuestCount], [MeetingTopic], [Attendees], [AttendeesEmail],
            [AgendaInfo], [AgendaJsonData], [AgendaAttachUrl], N'Đã huỷ'
        FROM [dbo].[CSR_Projects]
        WHERE [Project_id] = @ProjectId;
